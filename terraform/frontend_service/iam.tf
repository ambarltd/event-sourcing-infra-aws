...
resource "aws_iam_role" "ecs_execution_role" {
  name = "${var.environment_name}-frontend-ecs-execution-role"
...
resource "aws_iam_role_policy" "ecs_execution_ecr_access" {
  name = "${var.environment_name}-frontend-ecs-ecr-access"
...
resource "aws_iam_role" "ecs_task_role" {
  name = "${var.environment_name}-frontend-ecs-task-role"
...
resource "aws_iam_role_policy" "ecs_task_cloudwatch" {
  name = "${var.environment_name}-frontend-ecs-logs"
